...
namespace ThoiTrang.Areas.Admin.Controllers
{
    public class OrderController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Code,UserId,CreatedDate,ExportDate,DeliveryAddress,DeliveryName,DeliveryPhone,DeliveryEmail,Updated_at,Updated_by,Status")] Order order)
        {
